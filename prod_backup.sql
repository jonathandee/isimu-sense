...
\restrict SBQXVJI96n7T0M04hrM4NnuwOTLdNbtCiKij9ceEJfRLzQkKLQseUt9dvplt2xa
...
CREATE TABLE public.users (
    ...
    password_hash character varying(200) CONSTRAINT user_password_hash_not_null NOT NULL,
...
--
-- Name: user_id_seq; Type: SEQUENCE; Schema: public; Owner: jonathandangeni
--
...
ALTER SEQUENCE public.user_id_seq OWNER TO jonathandangeni;

--
-- Name: user_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: jonathandangeni
--
...
1	001	3	breeding	1	Male	2026-03-11	active	
\.
...
1	1	1	2026-03-12		50	\N	Cup number 5 per station\r\n
2	1	1	2026-03-12		50	\N	
\.
...
1	Tomatoes	Tengeru	Hybrid F2
2	Tomatoes	9081	Hybrid F1
3	Maize	SC 727	Hybrid Long variety
\.
...
1	Field B	0.5	Section
2	Field C	0.5	Section
3	Field D	1	Welcome Home
\.
...
1	1	1	2026-03-12	2026-06-14	active
\.
...
1	admin	scrypt:32768:8:1$KphvFFbrCw1GJ7Jr$d7d42daa7eb8d26e65e8f97fdf9a7361378e8606f88ac6eae8fa5c90ed0ce155e5fa44d21df9d196e0b189fe8be7a4e1ab1a6b5c6075fb3c17f8b6ebaea63f60	admin
\.
...
SELECT pg_catalog.setval('public.breeding_event_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.crop_type_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.field_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.finance_category_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.inventory_item_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.planting_id_seq', 1, true);
...
--
-- Name: user_id_seq; Type: SEQUENCE SET; Schema: public; Owner: jonathandangeni
--
...
--
-- Name: users user_pkey; Type: CONSTRAINT; Schema: public; Owner: jonathandangeni
--
...
--
-- Name: users user_username_key; Type: CONSTRAINT; Schema: public; Owner: jonathandangeni
--
...
\unrestrict SBQXVJI96n7T0M04hrM4NnuwOTLdNbtCiKij9ceEJfRLzQkKLQseUt9dvplt2xa
